...
import type {
  ATN, DecisionState,
  TerminalNode, TokenStream,
} from 'antlr4'
import {
  ATNDeserializer, DFA, FailedPredicateException,
  RecognitionException, NoViableAltException, BailErrorStrategy,
  Parser, ParserATNSimulator,
  RuleContext, ParserRuleContext, PredictionMode, PredictionContextCache, RuleNode,
  Token,
  Interval, IntervalSet,
} from 'antlr4'
import type KQueryParserListener from './KQueryParserListener.js'
...
export default class KQueryParser extends Parser {
  ...
  public result(): ResultContext {
    const localctx: ResultContext = new ResultContext(this, this._ctx, this.state)
  ...
  public union(): UnionContext {
    const localctx: UnionContext = new UnionContext(this, this._ctx, this.state)
  ...
  public intersection(): IntersectionContext {
    const localctx: IntersectionContext = new IntersectionContext(this, this._ctx, this.state)
  ...
  public clause(): ClauseContext {
    const localctx: ClauseContext = new ClauseContext(this, this._ctx, this.state)
  ...
  // @RuleVersion(0)
  public or(): OrContext {
    const localctx: OrContext = new OrContext(this, this._ctx, this.state)
  ...
  public and(): AndContext {
    const localctx: AndContext = new AndContext(this, this._ctx, this.state)
  ...
  public exclusion(): ExclusionContext {
    const localctx: ExclusionContext = new ExclusionContext(this, this._ctx, this.state)
  ...
  public entityClause(): EntityClauseContext {
    const localctx: EntityClauseContext = new EntityClauseContext(this, this._ctx, this.state)
  ...
  public grouping(): GroupingContext {
    const localctx: GroupingContext = new GroupingContext(this, this._ctx, this.state)
  ...
  public fieldValue(): FieldValueContext {
    const localctx: FieldValueContext = new FieldValueContext(this, this._ctx, this.state)
  ...
  public quotedValue(): QuotedValueContext {
    const localctx: QuotedValueContext = new QuotedValueContext(this, this._ctx, this.state)
