...
import { ResultContext } from "./KQueryParser";
import { QueryContext } from "./KQueryParser";
import { UnionContext } from "./KQueryParser";
import { IntersectionContext } from "./KQueryParser";
import { ClauseContext } from "./KQueryParser";
import { OrContext } from "./KQueryParser";
import { AndContext } from "./KQueryParser";
import { ExclusionContext } from "./KQueryParser";
import { EntityClauseContext } from "./KQueryParser";
import { GroupingContext } from "./KQueryParser";
import { FieldNameContext } from "./KQueryParser";
import { FieldValueContext } from "./KQueryParser";
import { QuotedValueContext } from "./KQueryParser";
...
export default class KQueryParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `KQueryParser.or`.
	 * @param ctx the parse tree
	 */
	enterOr?: (ctx: OrContext) => void;
	/**
	 * Exit a parse tree produced by `KQueryParser.or`.
	 * @param ctx the parse tree
	 */
	exitOr?: (ctx: OrContext) => void;
	/**
	 * Enter a parse tree produced by `KQueryParser.and`.
	 * @param ctx the parse tree
	 */
	enterAnd?: (ctx: AndContext) => void;
	/**
	 * Exit a parse tree produced by `KQueryParser.and`.
	 * @param ctx the parse tree
	 */
