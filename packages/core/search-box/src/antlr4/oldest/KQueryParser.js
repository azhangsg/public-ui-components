...
export default class KQueryParser extends Parser {
    ...
    // @RuleVersion(0)
    intersection() {
        let localctx = new IntersectionContext(this, this._ctx, this.state);
    ...
    // @RuleVersion(0)
    entityClause() {
        let localctx = new EntityClauseContext(this, this._ctx, this.state);
    ...
    // @RuleVersion(0)
    quotedValue() {
        let localctx = new QuotedValueContext(this, this._ctx, this.state);
